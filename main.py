...
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id,te.menu_1_1,caption=te.img_menu_1_1,reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_1_2')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_1_2, caption=te.img_menu_1_2, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_1_3')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_1_3, caption=te.img_menu_1_3, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_1_4')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_1_4, caption=te.img_menu_1_4, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_1_5')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_1_5, caption=te.img_menu_1_5, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_1_6')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_1_6, caption=te.img_menu_1_6, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_2_1')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_2_1, caption=te.img_menu_2_1, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_3_1')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_3_1, caption=te.img_menu_3_1, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)
...
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_3_2, caption=te.img_menu_3_2, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_3_3')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_3_3, caption=te.img_menu_3_3, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_3_4')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_3_4, caption=te.img_menu_3_4, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_3_5')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_3_5, caption=te.img_menu_3_5, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_3_6')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_3_6, caption=te.img_menu_3_6, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_3_7')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_3_7, caption=te.img_menu_3_7, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_4_1')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_4_1, caption=te.img_menu_4_1, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_4_2')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_4_2, caption=te.img_menu_4_2, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_4_3')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_4_3, caption=te.img_menu_4_3, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_5_1')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_5_1, caption=te.img_menu_5_1, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_5_2')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_5_2, caption=te.img_menu_5_2, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_6_1')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_6_1, caption=te.img_menu_6_1, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_6_2')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_6_2, caption=te.img_menu_6_2, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_7_1')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_7_1, caption=te.img_menu_7_1, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_7_2')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_7_2, caption=te.img_menu_7_2, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_7_3')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_7_3, caption=te.img_menu_7_3, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_7_4')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_7_4, caption=te.img_menu_7_4, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_7_5')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_7_5, caption=te.img_menu_7_5, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_7_6')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_7_6, caption=te.img_menu_7_6, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_8_1')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_8_1, caption=te.img_menu_8_1, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_8_2')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_8_2, caption=te.img_menu_8_2, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_8_3')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_8_3, caption=te.img_menu_8_3, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_8_4')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_8_4, caption=te.img_menu_8_4, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_9_1')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_9_1, caption=te.img_menu_9_1, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_9_2')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_9_2, caption=te.img_menu_9_2, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_9_3')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_9_3, caption=te.img_menu_9_3, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_10_1')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_10_1, caption=te.img_menu_10_1, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)

@dp.callback_query_handler(text='menu_11_1')
async def menu(msg: types.Message):
    id = msg.from_user.id
    await bot.send_photo(id, te.menu_11_1, caption=te.img_menu_11_1, reply_markup=kb.back)
    await bot.delete_message(msg.from_user.id, msg.message.message_id)
